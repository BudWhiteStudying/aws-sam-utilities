...
def add_function_to_manifest(snake_case_function_name, function_method, cf_manifest):
...
if __name__ == '__main__':
    ...
    updated_manifest = add_function_to_manifest(snake_case_name, http_method, manifest)

    shutil.copy(input_file if input_file else 'template.yaml', 'template.yaml.bak')
    with open('template.yaml', 'w+') as output_file:
        output_file.write(yaml.dump(updated_manifest))
